...
module.exports = async function handler(req, res) {
  ...
  if (requestUrl.pathname === '/gtv-logo.svg') {
    try {
      const logo = await fs.readFile(path.join(DATA_ROOT, 'gtv-logo.svg'));
